...
\usepackage[european, cuteinductors, RPvoltages]{circuitikz}
%-------------------------------------------------------------------------- 
%--------------------------------------------------------------------------
...
\lstset{keywordstyle=\upshape\bfseries,%
...
%--------------------------------------------------------------------------
% Un résumé en début de chapitre
\newenvironment{abstract}{\begin{minipage}{0.2\linewidth} {\Large \bf Résumé} \end{minipage}
